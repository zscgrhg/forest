    ...
    <table class="table">
        <#list ph.items as resources>
            ...
            <tr>
                ...
                <td><a href="detail?id=${resources.id}">detail</a></td>
                <td><a href="preedit?id=${resources.id}">edit</a></td>
                <td><a href="javascript:void(0)" onclick="destroyEntity('${resources.id}')">destroy</a></td>
            </tr>
