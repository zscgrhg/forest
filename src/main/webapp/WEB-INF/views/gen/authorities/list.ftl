    ...
    <table class="table">
        <#list ph.items as authorities>
            ...
            <tr>
                ...
                <td><a href="detail?authority=${authorities.authority}">detail</a></td>
                <td><a href="preedit?authority=${authorities.authority}">edit</a></td>
                <td><a href="javascript:void(0)" onclick="destroyEntity('${authorities.authority}')">destroy</a></td>
            </tr>
